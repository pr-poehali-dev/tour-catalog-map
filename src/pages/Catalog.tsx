                  ...
                  <CardContent className="p-0">
                    <div className="flex">
                      <div className="relative w-32 h-24 flex-shrink-0">
                        ...
                        />
                        <div className="absolute top-1 right-1 bg-white/90 backdrop-blur-sm px-1 py-0.5 rounded-full flex items-center">
                          <Icon
                            name="Star"
                            size={12}
                      ...
                      <div className="p-3 flex-1">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <Button
                            size="sm"
                            className="bg-primary hover:bg-accent text-xs px-2 py-1"
                          >
                            Подробнее
                          </Button>
                        </div>
